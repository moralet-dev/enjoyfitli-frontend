  ...
  <div class="wrapper">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form @submit.prevent="onSubmit">
          ...
          <div class="form-group privacy-policy">
            ...
            <label for="agree">
              {{ $t('iAgreeWith') }}
              <router-link :to="{name: 'public-offer'}" class="text-link">{{
                  $t('publicOffer')
                }}
              </router-link>
            </label>
      ...
      <Transition name="modal">
        <div v-if="showNext" class="modal-mask" @click="onRegFinished">
          <div class="modal-container success" @click.stop>
            <button class="close" @click="onRegFinished">
              <CloseIcon/>
            </button>
            <div class="modal-content">
